...
export const SUPERADMIN_INSERT_ORG_PAYLOAD = {
  ...
  DONT_ALLOW_DICTIONARY_WORDS: null,
  EAP: true,
  EMAIL: '',
  FAX_NO: '',
  FAX_NO_EXT: null,
  ...
  ID: '',
  IST: true,
  IS_NUM_MANDATE_IN_PWD: null,
  IS_PASSWORD_POLICY_APPLICABLE: null,
  IS_SPC_CHAR_MANDATE_IN_PWD: null,
  IS_UPPER_MANDATE_IN_PWD: null,
  LANGUAGE_ID: null,
  LAST_UPDATED_BY: null,
  LAST_UPDATED_DATE: '2020-08-11',
  LICENCE_END_DATE: '2026-09-02T07:33:14.072Z',
  LICENCE_END_DATES: '2026-9-2',
  LICENCE_END_DATEO: {
    Day: 2,
    Month: 9,
    Year: 2026,
  ...
  LOGIN_ATTEMPTS_TO_DISABLE: null,
  LOGO: '',
  MAIN_HEADER: '',
  MIN_PASSWORD_LENGTH: null,
  NAME: 'Test Organization 1.0.0.5',
  NO_OF_PREV_PASS_MATCH_NEW_PWD: null,
  OBS_CODE: null,
  ...
  EAP_CURRENCY_ID: '',
  CME_CURRENCY_ID: '',
  CHARITABLE_CURRENCY_ID: '',
  SPONSERSHIP_CURRENCY_ID: '',
  FILEID: '',
  FILENAME: '',
  DSFILEID: '',
  DSFILENAME: '',
  ...
  REPRESENTATIVE_PHONE_NO_EXT: 0,
  REPRESENTATIVE_ADDRESS: '',
  ADMINISTRATOR_NAME: '',
  ADMINISTRATOR_EMAIL: '',
  ADMINISTRATOR_PHONE_NO: '',
  ADMINISTRATOR_PHONE_NO_EXT: 0,
  ADMINISTRATOR_ADDRESS: '',
  AUTHTYPE: 'MED',
  FK_ACC_ATVY_EMAILID: null,
  FK_CORRES_EMAILID: null,
  TIMEZONE: 'UTC',
  CME: true,
  CHARITY: true,
  SPONSERSHIP: true,
  ...
  AUTHENTICATIONSLST: [
    {
      ID: '0',
      AUTH_NAME: 'Basic Authentication',
      AUTH_TYPE_CODE: 'Forms',
      STATUS: true,
      SAML_IDP_SIGNIN_URL: null,
      SAML_IDP_ISSUER_URL: null,
      SAML_IS_VER_CERT_FILE_UPLOADED: null,
      SAML_IS_PWD_PROTECTED: null,
      SAML_VER_CERT_PWD: null,
      CERT_TEXT_STORE_ID: null,
      SAML_IS_SIGNED_AUTH_REQUEST: null,
      SAML_IS_SIGNED_RESPONSE: null,
      SAML_IS_ENCRYPTED_ASSERTION: null,
      SAML_IS_SIGNED_ASSERTION: null,
      SAML_LOGIN_URL: null,
      SAML_ACS_URL: null,
      LDAP_SERVER_NAME: null,
      LDAP_SERVER_ALIAS_NAME: null,
      LDAP_PORT_NUMBER: null,
      LDAP_USER_DN: null,
      LDAP_IS_SSL: null,
      CERT_FILE_STORE_ID: null,
      IS_DEFAULT: true,
      RECORD_STATE: 0,
      CREATED_BY: null,
      CREATED_DATE: '0001-01-01T00:00:00',
      LAST_MODIFIED_BY: null,
      LAST_MODIFIED_DATE: '0001-01-01T00:00:00',
      ORGANIZATION_ID: null,
      OBS_CODE: null,
      LANGUAGE_ID: null,
      ORG_CODE: null,
      AUTH_TYPE_CODENavigation: null,
      CERT_TEXT_STORE: null,
      ORG_AUTHENTICATIONS: [],
      USERS: [],
      VER_CERT: null,
      FILE_NAME: null,
  ...
  URL: 'http://localhost:4200/test1005/login'
};
...
export const SUPERADMIN_UPDATE_ORG_PAYLOAD = {
  ...
  FAX_NO_EXT: null,
  GRANTS: true,
  ID: 'ae16f95d-494f-4937-ab44-2e05bf736ee4',
  IST: true,
  IS_NUM_MANDATE_IN_PWD: null,
  IS_PASSWORD_POLICY_APPLICABLE: null,
  IS_SPC_CHAR_MANDATE_IN_PWD: null,
  ...
  LAST_UPDATED_BY: null,
  LAST_UPDATED_DATE: '2020-08-11',
  LICENCE_END_DATE: '2026-09-02T18:29:59.000Z',
  LICENCE_END_DATES: '2026-9-2',
  LICENCE_END_DATEO: {
    Day: 2,
    Month: 9,
  ...
  MAIN_HEADER: '',
  MIN_PASSWORD_LENGTH: null,
  NAME: 'Test Organization 1.0.0.5 1788343905917',
  NO_OF_PREV_PASS_MATCH_NEW_PWD: null,
  OBS_CODE: null,
  ORGANIZATION_ID: null,
  PASSWORD_EXPIRY_DATE: null,
  ...
  WEB_SITE: '',
  ZIP: '',
  IST_CURRENCY_ID: '5A7E43425BD926BBE063F000000ACB19',
  EAP_CURRENCY_ID: '5A7E43425BD926BBE063F000000ACB19',
  CME_CURRENCY_ID: '5A7E43425BD926BBE063F000000ACB19',
  CHARITABLE_CURRENCY_ID: '5A7E43425BD926BBE063F000000ACB19',
  SPONSERSHIP_CURRENCY_ID: '5A7E43425BD926BBE063F000000ACB19',
  FILEID: '',
  FILENAME: '',
  DSFILEID: '',
  DSFILENAME: '',
  ...
  AUTHENTICATIONSLST: [
    {
      ...
      VER_CERT: null,
      FILE_NAME: null,
      ORG_AUTH_ID: '03CBDCE1-C02E-44C4-B4C8-8EE874DB2B5E'
    }
  ],
  URL: 'http://localhost:4200/test1005_834/login'
};

export const SUPERADMIN_REFRESH_ORG_PAYLOAD = {
  OrgId: '45146f52-8dba-4510-af2c-be2b191ec365',
  OrgName: 'Test Organization 1.0.0.3',
  IST: true,
  EAP: true,
  GRANTS: true,
  IS_ORG_ACCOUNT_IN_LOGI: false
...
export function getSuperAdminTestItems(
  ...
  const items: DetailedTestItem[] = [
    ...
    },
    {
      ...
      method: 'POST',
      payload: { ...SUPERADMIN_UPDATE_ORG_PAYLOAD, ID: context.firstOrgId },
    ...
    },
    {
      ...
      method: 'POST',
      payload: { OrgId: '45146f52-8dba-4510-af2c-be2b191ec365', OrgName: 'Test Organization 1.0.0.3' },
    ...
    },
    {
      ...
      method: 'POST',
      payload: SUPERADMIN_REFRESH_ORG_PAYLOAD,
