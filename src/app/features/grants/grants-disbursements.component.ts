...
@Component({
  selector: 'app-grants-disbursements',
  standalone: true,
    ...
    <div class="screen-container">
      <div class="screen-header">
        <div>
          ...
          <h2>Payment & Disbursement Ledger</h2>
          <p class="subtitle">Screen Permission: Disbursements (grants-disbursements). Financial payout audit & execution records.</p>
        </div>
      </div>
    </div>
  `,
...
export class GrantsDisbursementsComponent {}
